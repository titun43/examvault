...
class FirestoreService {
  ...
  // NOTE: The "Study Materials" feature (PDF content: Previous Year Papers,
  // Study Notes, Syllabus on the Subject Detail screen) was REMOVED from the
  // app. The study_materials Firestore collection, the StudyMaterialModel,
  // and the MaterialList / PdfViewer screens have all been deleted. The
  // Subject Detail screen now shows only the Tests content-type card.
  // (Previous Year Papers as a TEST TYPE — type='previous_year' on the tests
  // collection — is unaffected and still managed via Admin → Tests /
  // Previous Papers.)
}
